...
<div class="adv-search-mobile"  id="adv-search-mobile"> 
    ...
    <form role="search" method="get"   action="<?php print $adv_submit; ?>" >
        ...
        ?>
            ...
            <input type="text" id="adv_location_mobile" class="form-control" name="adv_location"  placeholder="<?php _e('Search State, City or Zip','wpestate');?>" value="">      
        ...
        <button class="wpb_button  wpb_btn-info wpb_btn-large" id="advanced_submit_2_mobile"><?php _e('Search Subleases','wpestate');?></button>
