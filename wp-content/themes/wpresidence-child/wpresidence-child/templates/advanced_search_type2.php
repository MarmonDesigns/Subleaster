...
<div class="adv-search-1  adv-search-2 <?php echo $close_class;?>" id="adv-search-2" data-postid="<?php echo $post_id; ?>"> 
    ...
    <div class="transparent-wrapper">
        ...
        <form role="search" method="get" class="visible-wrapper"  action="<?php print $adv_submit; ?>" >
                ...
                <input type="text" id="adv_location" class="form-control" name="adv_location"  placeholder="<?php _e('Search State, City or Zip','wpestate');?>" value="">      
                ...
                <div class="dropdown form-control hideControl" >
            ...
            <input name="submit" type="submit" class="wpb_button  wpb_btn-info wpb_btn-large vc_button" id="advanced_submit_22" value="<?php _e('SEARCH SUBLEASES','wpestate');?>">
