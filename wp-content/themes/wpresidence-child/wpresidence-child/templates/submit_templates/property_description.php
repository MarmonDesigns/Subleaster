...
<div class="submit_container_header"><?php _e('Sublease Description & Price','wpestate');?></div>
...
<p class="full_form">
   ...
   <textarea id="description"  class="form-control"  name="wpestate_description" cols="50" rows="6"><?php print $submit_description; ?></textarea>
</p>
