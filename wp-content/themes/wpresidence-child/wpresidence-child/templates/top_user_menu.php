...
<?php }else{ ?>
    <div class="user_menu" id="user_menu_u">   
        ...
        <div class="submit_action"><?php _e('Submit Sublease','wpestate');?></div>
<?php } ?>   
...
?> 
    <ul id="user_menu_open" class="dropdown-menu menulist topmenux" role="menu" aria-labelledby="user_menu_trigger"> 
        ...
        <?php if($home_url!=$dash_link){?>
         <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php print $dash_link;?>"     class="active_dash"><i class="fa fa-map-marker"></i><?php _e('My Sublease List','wpestate');?></a></li>
        ...
        <?php if($home_url!=$add_link){?>
          <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php print $add_link;?>"      class="active_add"><i class="fa fa-plus"></i><?php _e('Add New Sublease','wpestate');?></a></li>
