...
<div class="user_tab_menu">
    ...
    <div class="user_dashboard_links">
        ...
        <?php if( $dash_link!=$home_url ){ ?>
            <a href="<?php print $dash_link;?>"     class="<?php print $activedash; ?>"> <i class="fa fa-map-marker"></i> <?php _e('My Sublease List','wpestate');?></a>
        <?php } ?>
        <?php if( $add_link!=$home_url ){ ?>
            <a href="<?php print $add_link;?>"      class="<?php print $activeadd; ?>"> <i class="fa fa-plus"></i><?php _e('Add New Sublease','wpestate');?></a>  
        <?php } ?>
