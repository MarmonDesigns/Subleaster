    ...
    <div class="panel panel-default">
        <div class="panel-heading">
             ...
             if($property_details_text=='') {
                 print'<a data-toggle="collapse" data-parent="#accordion_prop_details" href="#collapseOne"><h4 class="panel-title" id="prop_det">'.__('Sublease Details', 'wpestate').'  </h4></a>';
             }else{
