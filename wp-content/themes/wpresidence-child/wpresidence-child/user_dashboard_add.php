...
if( 'POST' == $_SERVER['REQUEST_METHOD'] && $_POST['action']=='view' ) {
    ...
    //    $property_state                 =   wp_kses( $_POST['property_state'],$allowed_html);
        ...
        if($submit_title==''){
            $has_errors=true;
            $errors[]=__('Please submit a title for your sublease','wpestate');
        }
        
        if($submit_description==''){
            $has_errors=true;
            $errors[]=__('Please submit a description for your sublease','wpestate');
        }
        
        if ($_POST['attachid']==''){
            $has_errors=true;
            $errors[]=__('Please submit an image for your sublease','wpestate'); 
        }
        
        if($property_address==''){
            $has_errors=true;
            $errors[]=__('Please submit an address for your sublease','wpestate');
        }
