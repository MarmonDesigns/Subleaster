            ...
            <dl class="menu-item-bar">
                <dt class="menu-item-handle">
                    ...
                    <span class="item-controls">
                        ...
                        <a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php esc_attr_e('Edit Menu Item', "wpestate"); ?>" href="<?php
            ...
            <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
                ...
                <p class="field-megamenu-checkbox">
                    ...
                    <label for="edit-menu-item-megamenu-<?php echo $item_id; ?>">
                        <input type="checkbox" value="enabled" class="edit-menu-item-wpestate-megamenu-check" id="edit-menu-item-megamenu-<?php echo $item_id; ?>" name="edit-menu-item-megamenu[<?php echo $item_id; ?>]" <?php echo $value; ?> />
                ...
                <a href="#" id="wpestate-media-upload-<?php echo $item_id; ?>" class="load_back_menu  "><?php _e( 'Upload Background Image | ', 'wpestate' ); ?></a>
              
                <a href="#" id="wpestate-media-remove-<?php echo $item_id; ?>" class="remove-megamenu-background" style="<?php echo ( trim( $item->megamenu_background ) ) ? 'display: inline;' : '';?>"><?php _e('Remove Image','wpestate');?></a>
                <p class="field-megamenu-background description description-wide">
                    <label for="edit-menu-item-megamenu-background-<?php echo $item_id; ?>">
                        <input type="hidden" id="edit-menu-item-megamenu-background-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megamenu-background" name="menu-item-megamenu-background[<?php echo $item_id; ?>]" value="<?php echo $item->megamenu_background; ?>" />
                        <img src="<?php echo $item->megamenu_background; ?>" id="wpestate-media-img-<?php echo $item_id; ?>" class="wpestate-megamenu-background-image" style="<?php echo ( trim( $item->megamenu_background ) ) ? 'display: inline;' : '';?>" />
                ...
                <p class="field-megamenu-checkbox-border">
                    ...
                    ?>
                    <label for="menu-item-megamenu-border-<?php echo $item_id; ?>">
                        <input type="checkbox" value="enabled" class="menu-item-megamenu-border" id="menu-item-megamenu-border-<?php echo $item_id; ?>" name="menu-item-megamenu-border[<?php echo $item_id; ?>]" <?php echo $value; ?> />
                ...
                <div class="menu-item-actions description-wide submitbox">
                    ...
                    ); ?>"><?php _e('Remove', "wpestate" ); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
                        ?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e('Cancel', "wpestate"); ?></a>
                </div>
